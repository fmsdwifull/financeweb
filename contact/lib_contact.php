...
$txt = <<<EOD
		...
		<p style="text-align:center;font-weight:bold">“<span>$project_name</span>”定向融资计划</p>
...
$txt3 = <<<EOD
<p style="text-align:center">“<span>$project_name</span>”定向融资计划</p>
...
$txt3 = <<<EOD
<p></p>
<p style="text-indent: 20px;">    感谢您加入“$project_name”定向融资计划（以下简称“标的计划”）。“政金网”平台（www.zhengjinnet.com）系和瀚金融信息服务（上海）有限公司所属的互联网金融信息服务撮合平台，发行人<font>$owner_name</font>作为融资人在“政金网”上线标的计划，标的计划经“政金网”登记、撮合、交易。
</p>
...
$tt = "A类认购人、B类认购人、C类认购人和D类认购人";
$tmp0 = "    9.认购人：指认购加入标的计划的投资者，即具有完全民事行为能力且符合法律规定的合格投资者条件的自然人、法人及依法成立的其他组织，如认购人系“政金网”注册用户，其须承诺符合《政金网网站注册用户服务协议（个人用户/企业用户）》的要求。";
$tmp = "    根据《中华人民共和国合同法》以及其他有关法律法规的规定，在平等自愿、诚实信用、充分保护投资者合法权益的原则基础上，订立《".$owner_name."“".$project_name."”定向融资计划认购合同》（以下简称“认购合同”）。";
$tmp2 = "    2.认购合同：指认购人与发行人签订的《".$owner_name."“".$project_name."”定向融资计划认购合同》及其任何有效修订和补充。";
$tmp3 = "    3.标的计划：指发行人根据本合同设立的“".$owner_name."‘".$project_name."’定向融资计划”。";
$tmp4 = "    4.投资计划说明书：指《".$owner_name."“".$project_name."”定向融资计划投资说明书》及其任何有效修订和补充。";
$tmp5 = "    5.认购风险申明书：指投资者认购标的计划时签署的《".$owner_name."“".$project_name."”定向融资计划认购风险申明书》及其任何有效修订和补充。";
...
$tmp9 = "    1、标的计划的名称为“".$owner_name."‘".$project_name."’定向融资计划”。";
...
<p style="text-indent: 20px;">    23.法律法规：指中国现行有效并公布实施的法律、行政法规、部门规章、司法解释及监管部门的决定、通知等。</p>
<p style="text-indent: 20px;">    24.工作日：指中华人民共和国国务院规定的金融机构正常营业日。</p>
<p style="text-indent: 20px;">    25.年、月、日：指日历年、月、日。</p>
<p style="text-indent: 20px;">    26.中国：指中华人民共和国，在认购合同中，不包括香港特别行政区、澳门特别行政区和台湾地区。</p>
<p style="text-indent: 20px;">    27.元：指人民币元。</p>
<p></p>
...
<p style="text-indent: 20px;">    5投资财产来源及用途合法。认购人按照本合同认购标的计划份额所运用的资金来源合法，为其合法所有或合法管理的资金，非为毒品犯罪、黑社会性质的组织犯罪、恐怖活动犯罪、走私犯罪、贪污贿赂犯罪、破坏金融管理秩序犯罪、金融诈骗犯罪等犯罪所得，并非金融机构信贷资金，借贷资金或其他</p>
...
$txt7 = <<<EOD
<p>负债资金，且不存在任何已有的或潜在的法律纠纷且可用于本合同约定之用途。认购人不得非法汇集他人资金参与标的计划；采用多人拼凑方式购买标的计划的，其拼凑人的债权和收益权不受法律保护。认购人承诺认购人有合法且完整的权利将资金用于标的计划，该等运用符合法律及其他相关合同的要求，并符合相关产业政策。</p>
...
<p style="text-indent: 20px;">    名称：和瀚金融信息服务（上海）有限公司</p>
...
<p></p>
<p style="text-align:center;font-weight:bold">五、标的计划募集成功的条件</p>
...
$pdf->AddPage();
$pdf->SetFont('stsongstdlight', '', 11, '', true);
$txt7  = "（此页为编号为【".$contract_no."】的《".$owner_name."“".$project_name."”定向融资计划认购合同》之签署页，无正文）";
