...
/* 业务管理 */
$_LANG['seller_order'] = '订单管理';
$_LANG['seller_reserve'] = '预约管理';
$_LANG['seller_user'] = '会员管理';
$_LANG['seller_setting'] = '个人设置';

/* 团队管理 */
$_LANG['team_order'] = '订单管理';
$_LANG['team_reserve'] = '预约管理';
$_LANG['team_user'] = '会员管理';

/* 业务员管理 */
$_LANG['seller_list']='业务员列表';
