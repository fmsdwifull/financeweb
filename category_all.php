...
$url_notype= $path."/category.php?id=".$id;
$url_noperiod= $path."/category.php?id=".$id;
$url_nostatus= $path."/category.php?id=".$id;

if (isset($_GET["type"])||!empty($_GET["type"])){
	$url_noperiod=$url_noperiod."&type=".$_GET["type"];
	$url_nostatus=$url_nostatus."&type=".$_GET["type"];
	$smarty->assign('url_type',         	$_GET["type"]);
}else{
	$smarty->assign('url_type',         	0);
}
if (isset($_GET["period"])||!empty($_GET["period"])){
	$url_notype=$url_notype."&period=".$_GET["period"];
...
if (isset($_GET["status"])||!empty($_GET["status"])){
	$url_notype=$url_notype."&status=".$_GET["status"];
...
$smarty->assign('url_notype',         	$url_notype);
...
function category_get_goods($children, $brand, $min, $max, $ext, $size, $page, $sort, $order)
{
    ...
    $sql = 'SELECT g.goods_id, g.goods_name, g.goods_start_time, g.goods_end_time, g.goods_period, g.goods_rest_number,g.goods_level, g.goods_name_style, g.goods_total_number, g.goods_rest_number, goods_interest_rate, g.goods_period, g.goods_min_buy, g.market_price, g.is_new, g.is_best, g.is_hot, g.shop_price AS org_price, ' .
            ...
            "WHERE $where $ext $where_period ORDER BY g.goods_start_time DESC";
