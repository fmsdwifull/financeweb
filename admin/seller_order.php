...
if ($_REQUEST['act'] == 'list')
{
    ...
    $order_list = order_list($admin_id);
    ...
    /* 显示模板 */
    assign_query_info();
    $smarty->display('seller_order_list.htm');
}
elseif ($_REQUEST['act'] == 'query')
{
    ...
    make_json_result($smarty->fetch('seller_order_list.htm'), '', array('filter' => $order_list['filter'], 'page_count' => $order_list['page_count']));
}
/**
 *  获取订单列表信息
 *
