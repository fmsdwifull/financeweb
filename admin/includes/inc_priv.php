...
//商品管理权限
	...
	$purview["project_list"]		 = 'project_list';
	$purview["fuiou_list"]		 = 'fuiou_list';
...
//会员管理权限
	...
	$purview['11_user_reserve'] = 'users_manage';
...
// 业务管理
    $purview['seller_order']         = 'seller_order';
    $purview['seller_reserve']       = 'seller_reserve';
    $purview['seller_user']    	     = 'seller_user';
	
// 团队管理
    $purview['team_order']           = 'team_order';
    $purview['team_reserve']         = 'team_reserve';
    $purview['team_user']    	     = 'team_user';
	
//业务员管理
	$purview['seller_list']				='seller_list';
