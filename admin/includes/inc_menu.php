...
$modules['02_cat_and_goods']['project_list']     = 'project.php?act=list';
...
$modules['02_cat_and_goods']['fuiou_list']             = 'fuiou_list.php?act=fuiou_list';//富友账号管理
...
$modules['08_members']['11_user_reserve']    		= 'user_reserve.php';
...
$modules['17_seller']['seller_order']                    = 'seller_order.php?act=list';
$modules['17_seller']['seller_reserve']                  = 'seller_reserve.php';
$modules['17_seller']['seller_user']                     = 'seller_user.php?act=list';
$modules['17_seller']['seller_setting']                  = 'privilege.php?act=modif';

$modules['18_team']['team_order']                        = 'team_order.php?act=list';
$modules['18_team']['team_reserve']                      = 'team_reserve.php';
$modules['18_team']['team_user']                         = 'team_user.php?act=list';

$modules['19_seller_manger']['seller_list']				='seller_list.php?act=list';
?>
