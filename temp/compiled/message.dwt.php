...
<div class="block">
  <div class="box">
   <div class="box_1" style="margin-bottom:20px">
    <h3><span style=""><?php echo $this->_var['lang']['system_info']; ?></span></h3>
    <div class="boxCenterList RelaArticle" align="center">
      <div style="margin:20px auto;">
      <p  style="font-size:16px;font-family:黑体;color:#333;font-weight:bold"><?php echo $this->_var['message']['content']; ?></p>
        <div class="blank"></div>
