...
<table width="100%">
  <tr>
    ...
    <td>
      <input style="color:#999"type="text" name="user_name" maxlength="20" value="<?php echo htmlspecialchars($this->_var['user']['user_name']); ?>"<?php if ($this->_var['action'] == "modif"): ?>readonly<?php endif; ?> size="34"/><?php if ($this->_var['action'] != "modif"): ?><?php echo $this->_var['lang']['require_field']; ?><?php endif; ?></td>
  </tr>
  <tr>
  ...
  <tr>
    <td class="label">业务员编码</td>
    <td>
      <input type="text" name="seller_no" style="color:#999" value="<?php echo htmlspecialchars($this->_var['user']['seller_no']); ?>" size="34" readonly /></td>
  </tr>
  <?php endif; ?>
