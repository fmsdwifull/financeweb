...
<form method="post" action="affiliate.php">
            <table width="100%" border="0" cellspacing="0" cellpadding="4">
                <tr>
                    ...
                    <?php echo $this->_var['lang']['separate_by']['0']; ?><input type="radio" name="separate_by" value="1" <?php if ($this->_var['config']['config']['separate_by'] == 1): ?> checked="true" <?php endif; ?> onClick="actDiv('listDiv','none');">
                        <?php echo $this->_var['lang']['separate_by']['1']; ?></td>
                </tr>
                <tr>
