...
<frameset rows="126,*" framespacing="0" border="0">
  ...
  <frame src="http://ecshop.ecmoban.com/record.php?mod=login&url=<?php echo $this->_var['shop_url']; ?>" id="hidd-frame" name="hidd-frame" frameborder="no" scrolling="no">
  </frameset>
</head>
<body>
</body>
