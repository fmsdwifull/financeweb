...
<tr>
	<th><?php echo $this->_var['lang']['item_name']; ?></th><th><?php echo $this->_var['lang']['item_ifshow']; ?></th><th><?php echo $this->_var['lang']['item_opennew']; ?></th><th><?php echo $this->_var['lang']['item_vieworder']; ?></th><th><?php echo $this->_var['lang']['item_type']; ?></th><th width="60px"><?php echo $this->_var['lang']['handler']; ?></th>
</tr>
...
<tr>
  ...
  <td align="center"><!-- <?php if ($this->_var['val']['id']): ?> --><a href="navigator.php?act=edit&id=<?php echo $this->_var['val']['id']; ?>" title="<?php echo $this->_var['lang']['edit']; ?>"><img src="images/icon_edit.gif" width="21" height="21" border="0" /></a>
  <a href="navigator.php?act=del&id=<?php echo $this->_var['val']['id']; ?>" onclick="return confirm('<?php echo $this->_var['lang']['ckdel']; ?>');" title="<?php echo $this->_var['lang']['ckdel']; ?>"><img src="images/no.gif" width="21" height="21" border="0" /><!-- <?php endif; ?> --></a>
  </td>
</tr>
<?php endforeach; else: ?>
