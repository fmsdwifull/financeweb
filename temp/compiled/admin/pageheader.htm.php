...
<head>
<title>政金网管理控制台<?php if ($this->_var['ur_here']): ?><?php echo $this->_var['ur_here']; ?> <?php endif; ?></title>
...
<?php endif; ?>
<span class="action-span1"><a href="index.php?act=main">政金网管理控制台</a> </span><span id="search_id" class="action-span1"><?php if ($this->_var['ur_here']): ?> - <?php echo $this->_var['ur_here']; ?> <?php endif; ?></span>
