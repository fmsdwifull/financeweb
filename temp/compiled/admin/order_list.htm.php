...
<table cellpadding="3" cellspacing="1">
  <tr>
    ...
    <th><a href="javascript:listTable.sort('consignee', 'DESC'); ">用户实名</a><?php echo $this->_var['sort_consignee']; ?></th>
	<th>产品名称</th>
	<th>详情</th>
...
?>
  <tr>
    <td valign="top" nowrap="nowrap"><input type="checkbox" name="checkboxes" value="<?php echo $this->_var['order']['order_sn']; ?>" /><a href="order.php?act=info&order_id=<?php echo $this->_var['order']['order_id']; ?>" id="order_<?php echo $this->_var['okey']; ?>"><?php echo $this->_var['order']['order_id']; ?></a></td>
    <td align="center" valign="top"><?php echo htmlspecialchars($this->_var['order']['user_name']); ?><br /><?php echo $this->_var['order']['short_order_time']; ?></td>
    <td align="center" valign="top"><?php echo htmlspecialchars($this->_var['order']['true_name']); ?><br /><?php echo htmlspecialchars($this->_var['order']['id_number']); ?></td>
	<td align="center" valign="top"><?php echo htmlspecialchars($this->_var['order']['goods_name']); ?></td>
	<td align="center" valign="top"><?php echo $this->_var['order']['transfer_detail']; ?></td>
    <td align="center" valign="top" nowrap="nowrap"><?php echo $this->_var['order']['formated_order_amount']; ?></td>
	<td align="center" valign="top"><?php echo $this->_var['order']['seller_name']; ?></td>
	<td align="center" valign="top"><?php echo $this->_var['order']['mac']; ?></td>
