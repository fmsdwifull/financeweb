...
<table cellpadding="3" cellspacing="1">
  <tr>
    ...
    <th><!-- <a href="javascript:listTable.sort('goods_sn'); "><?php echo $this->_var['lang']['goods_sn']; ?></a>-->产品期限</th>
    ...
    <th><!-- <a href="javascript:listTable.sort('goods_rest_number'); "><?php echo $this->_var['lang']['goods_number']; ?></a>-->项目剩余金额</th>
    <?php endif; ?>
	<th><!-- <a href="javascript:listTable.sort('shop_price'); "><?php echo $this->_var['lang']['shop_price']; ?></a>-->起投金额</th>
...
?>
  <tr>
    ...
    <td  align="center" class="first-cell" style="<?php if ($this->_var['goods']['is_promote']): ?>color:red;<?php endif; ?>"><span onclick="listTable.edit(this, 'edit_goods_name', <?php echo $this->_var['goods']['goods_id']; ?>)"><?php echo htmlspecialchars($this->_var['goods']['goods_name']); ?></span></td>
	...
	<td align="center"><?php echo $this->_var['goods']['goods_period']; ?></td>
    ...
    <?php if ($this->_var['use_storage']): ?>
    <td align="center"><!-- <span onclick="listTable.edit(this, 'edit_goods_number', <?php echo $this->_var['goods']['goods_id']; ?>)"> --><?php echo $this->_var['goods']['goods_rest_number']; ?></span></td>
    <?php endif; ?>
	<td align="center"><!-- <span onclick="listTable.edit(this, 'edit_goods_price', <?php echo $this->_var['goods']['goods_id']; ?>)"> </span>--><?php echo $this->_var['goods']['goods_min_buy']; ?></td>
    <td align="center">
...
?>
        <a href="<?php echo $this->_var['handler']['url']; ?>&goods_id=<?php echo $this->_var['goods']['goods_id']; ?>" title="<?php echo $this->_var['handler']['title']; ?>"><img src="images/<?php echo $this->_var['handler']['img']; ?>" width="21" height="21" border="0" /></a>
